...
export type ContractName =
  ...
  | 'Morpho' | 'USDG' | 'MockUSDG' | 'StockToken' | 'MockStockToken' | 'MockFeed' | 'MockIRM';
...
export const CONTRACT_ORDER: ContractName[] = ([
  ...
  'VigilBackstop', 'VigilPreLiquidation', 'VigilLossReporter', 'Morpho', 'USDG', 'MockUSDG', 'StockToken', 'MockStockToken', 'MockFeed', 'MockIRM',
