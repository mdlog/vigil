...
describe('deployment manifest', () => {
  ...
  it('has a checksummed address for all 15 contracts (v4: 11 deployed + Paxos USDG + Robinhood TSLA + the migration demo pair)', () => {
    expect(CONTRACT_ORDER).toHaveLength(15);
    ...
    expect(CONTRACT_ORDER).toContain('VigilMigrator');
  });
